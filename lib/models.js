...
// Moderator: a FAST, cheap model — the advisor must not feel slower than the run.
// (Chose deepseek-v4-flash over v4-pro deliberately: quality is ample for a
// 4-section synthesis, and streaming makes it appear ~instant. See DESIGN.md.)
const MODERATOR = {
  id: 'deepseek-v4-flash-0731',
  system:
